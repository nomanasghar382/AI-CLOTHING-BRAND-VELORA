...
class Product extends Model
{
    use SoftDeletes;
    protected $guarded = [];
    protected function casts(): array { return ['dimensions' => 'array', 'is_featured' => 'boolean', 'is_trending' => 'boolean', 'is_new_arrival' => 'boolean', 'published_at' => 'datetime', 'price' => 'decimal:2', 'sale_price' => 'decimal:2']; }
