...
class CheckoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = ['shipping_rate_id' => ['nullable', 'integer', 'exists:shipping_rates,id'], 'coupon_code' => ['nullable', 'string', 'max:64'], 'payment_provider' => ['required', Rule::in(['cod', 'stripe', 'paypal'])], 'currency' => ['nullable', 'string', 'size:3'], 'locale' => ['nullable', 'string', 'max:10'], 'notes' => ['nullable', 'string', 'max:2000'], 'billing_address' => ['nullable', 'array']];
